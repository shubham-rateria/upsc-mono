...
exports.getBOW = exports.getBOWFromString = void 0;
...
function getBOWFromString(keyword) {
...
exports.getBOWFromString = getBOWFromString;
function getBOW(keywords) {
    const punctuationRegex = /[.,\/#!$%\^&\*;:{}=\-_`~()]/g;
    const apostropheRegex = /'/g;
    const uniqueWords = new Set();
