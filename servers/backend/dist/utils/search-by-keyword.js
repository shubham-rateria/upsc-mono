...
exports.searchByKeywordNot = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (subjectTags) {
            ...
            for (const tag of subjectTags) {
                if (tag.level === "l0") {
                    if (!tag.optionalsId) {
                        l0Categories.push(usn_common_1.mapTagTypeToNumber[tag.type]);
                    }
                    else {
            ...
            if (l1Tags.length > 0) {
                ...
                // });
                additionalDocumentQueries["$match"]["l0_categories"] = [
                    usn_common_1.mapTagTypeToNumber[l1Tags[0].type],
                ];
            }
            ...
            if (l2Tags.length > 0) {
                ...
                // });
                additionalDocumentQueries["$match"]["l0_categories"] = [
                    usn_common_1.mapTagTypeToNumber[l2Tags[0].type],
                ];
            }
        }
        ...
        docMap.forEach((value, key) => {
            ...
            documentsResult.push(Object.assign(Object.assign({}, value), { pages: Array.from(pages.values()) }));
        });
...
function searchByKeywordNot({ keyword, pageNumber = 1, documentType, subjectTags, topper, }) {
    return __awaiter(this, void 0, void 0, function* () {
        /**
         * if mongoose is disconnected, throw an error
         */
        ...
        if (subjectTags) {
            ...
            if (l1Tags.length > 0) {
                additionalDocumentQueries["$match"]["l0_categories"] = {
                    $not: { $in: [usn_common_1.mapTagTypeToNumber[l1Tags[0].type]] },
                };
            }
            const l2Tags = subjectTags.filter((tag) => tag.level === "l2");
            if (l2Tags.length > 0) {
                additionalDocumentQueries["$match"]["l0_categories"] = {
                    $not: { $in: [usn_common_1.mapTagTypeToNumber[l2Tags[0].type]] },
                };
            }
        }
        if (Object.keys(additionalDocumentQueries.$match).length > 0) {
...
exports.searchByKeywordNot = searchByKeywordNot;
